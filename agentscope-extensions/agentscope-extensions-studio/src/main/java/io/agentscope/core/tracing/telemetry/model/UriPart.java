...
/** {@summary Represents an external referenced file sent to the model by URI. (Represents an external referenced file sent to the model by URI.)} Represents an external referenced file sent to the model by URI. */
