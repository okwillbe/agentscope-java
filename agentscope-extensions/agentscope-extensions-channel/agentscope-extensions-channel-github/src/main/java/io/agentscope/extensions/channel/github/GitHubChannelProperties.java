...
/**
 * {@summary Provider-specific configuration for a single GitHub channel instance, sourced from the (Provider-specific configuration for a single GitHub channel instance, sourced from the)}
