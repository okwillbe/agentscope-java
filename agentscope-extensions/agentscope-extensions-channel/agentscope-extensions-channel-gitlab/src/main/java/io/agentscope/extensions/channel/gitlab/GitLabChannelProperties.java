...
/**
 * {@summary Provider-specific configuration for a single GitLab channel instance, sourced from the (Provider-specific configuration for a single GitLab channel instance, sourced from the)}
